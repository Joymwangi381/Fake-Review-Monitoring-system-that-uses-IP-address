...
INSERT INTO `comments` (`id`, `pid`, `pname`, `username`, `email`, `comments`, `review`, `ip`) VALUES
(1, 110, '', 'Shiva Achar', '', NULL, '', '127.0.0.1');
...
INSERT INTO `orders` (`order_id`, `username`, `email`, `pid`, `pname`, `price`, `quantity`, `total`, `address`, `date`, `ip`) VALUES
(2, 'Shiva Achar', 'shiva111@gmail.com', '12 ', 'Levis Blue Shirt', 1500, 3, 4500, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2018-03-18', NULL),
(3, 'Shiva Achar', 'shiva111@gmail.com', '11 ', 'Levis White Shirt', 1000, 1, 1000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-02-23', NULL),
(4, 'Shiva Achar', 'shiva111@gmail.com', '11 ', 'Levis White Shirt', 1000, 2, 2000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-02-23', NULL),
(5, 'Shiva Achar', 'shiva111@gmail.com', '113 ', 'Levis Blue Jeans', 900, 1, 900, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-02-23', NULL),
(6, 'Shiva Achar', 'shiva111@gmail.com', '110 ', 'Adidas Red Shirt', 1100, 2, 2200, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-02-23', NULL),
(7, 'Shiva Achar', 'shiva111@gmail.com', '113 ', 'Levis Blue Jeans', 900, 1, 900, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-02-23', NULL),
(8, 'Shiva Achar', 'shiva111@gmail.com', '113 ', 'Levis Blue Jeans', 900, 2, 1800, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-02-23', '1270'),
(9, 'Shiva Achar', 'shiva111@gmail.com', '11 ', 'Levis White Shirt', 1000, 2, 2000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-02-26', '1270'),
(10, 'Shiva Achar', 'shiva111@gmail.com', '11', 'Levis White Shirt', 1000, 2, 2000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-02-27', '1270'),
(11, 'Shiva Achar', 'shiva111@gmail.com', '11 ', 'Levis White Shirt', 1000, 2, 2000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-03', '1270'),
(12, 'Shiva Achar', 'shiva111@gmail.com', '110 ', 'Adidas Red Shirt', 1100, 2, 2200, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-03', '1270'),
(13, 'Shiva Achar', 'shiva111@gmail.com', '11 ', 'Levis White Shirt', 1000, 2, 2000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-03', '1270'),
(14, 'Shiva Achar', 'shiva111@gmail.com', '110 ', 'Adidas Red Shirt', 1100, 2, 2200, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-04', '1270'),
(15, 'Shiva Achar', 'shiva111@gmail.com', '51 ', 'Adidas Football', 3000, 2, 6000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-04', NULL),
(16, 'Shiva Achar', 'shiva111@gmail.com', '111 ', 'Under Armour Blue Shirt', 1000, 2, 2000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-04', '1270'),
(17, 'Shiva Achar', 'shiva111@gmail.com', '112 ', 'US Polo Yellow Shirt', 1500, 2, 3000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-04', '1270'),
(22, 'Shiva Achar', 'shiva111@gmail.com', '11 ', 'Levis White Shirt', 1000, 3, 3000, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-05', ''),
(23, 'Shiva Achar', 'shiva111@gmail.com', '110 ', 'Adidas Red Shirt', 1100, 2, 2200, '#34, 5th Cross, Malleshwaram, Bangalore - 01', '2024-03-05', ''),
(25, 'Shiva Achar', 'shiva111@gmail.com', '110 ', 'Adidas Red Shirt', 1100, 1, 1100, '', '2024-03-05', '127.0.0.1'),
(27, 'Shiva Achar', 'shiva111@gmail.com', '110 ', 'Adidas Red Shirt', 1100, 2, 2200, '', '2024-03-05', '127.0.0.1');
...
(2, '21', 'Soch Kurta', 1200, 'clothes.jpg', 'Stylish kurta by Soch. Available in S, M, L, XL, XXL'),
(2, '210', 'Shree leggings', 450, 'd1.jpg', 'A pair of mustard yellow knitted churidar leggings, has an elasticated waistband'),
(2, '211', 'plusS Olive Green Solid Top', 800, 'd2.jpg', 'Olive green solid knitted regular top, has a round neck, three-quarter sleeves, button closure, has tie-up detail'),
(2, '212', 'Imara Yellow Printed Top', 780, 'd3.jpg', 'Yellow printed woven top, has a round neck, short sleeves, button closure'),
(2, '213', 'Biba Lehenga Dupatta', 4000, 'd4.jpg', 'Green and golden embellished lehenga choli with dupatta\r\nGreen embroidered choli, has a round neck, sleeveless, a full hook-and-eye placket on the back, beaded detail.'),
(2, '214', 'Yellow Lehenga Choli Dupatta', 1580, 'd5.jpg', 'Green and orange printed lehenga choli with dupatta\r\nOrange printed flared lehenga, has an elasticated waistband with a concealed zip closure on one side, lace trim along the hem, an attached lining.'),
(2, '215', 'RARE Blouson Top', 600, 'd6.jpg', 'Off-white, peach-coloured and navy printed woven blouson top with pleated detail, has a round neck, sleeveless, elasticated hem, and a cut-out detail on the back'),
(2, '22', 'Soch Saree', 1700, 'd7.jpg', 'Stylish and elegant saree by Soch. Comes with blouse piece'),
(2, '23', 'Soch Pink Salwar', 1200, 'd8.jpg', 'Stylish Salwar by Soch. Available in S, M, L, XL, XXL'),
(2, '24', 'Soch Black Salwar', 1500, 'd9.jpg', 'Stylish kurta by Soch. Available in S, M, L, XL, XXL'),
(2, '25', 'Libas Grey Straight Kurta', 1200, 'd10.jpg', 'Grey and navy printed straight kurta, has a round neck, three-quarter sleeves, straight hem, side slits'),
(2, '26', 'Libas Blue Straight Kurta', 1750, 'd11.jpg', 'Navy solid straight kurta, has a round neck, short sleeves, curved hem'),
(2, '27', 'Mimosa Saree', 1780, 'd12.jpg', 'Navy blue Kanjeevaram woven design saree, has a zari border'),
(2, '28', 'Chennai Silks Saree', 4500, 'd13.jpg', 'Beige woven design saree, has a zari border'),
(2, '29', 'Panit leggings', 400, 'd14.jpg', 'Red knitted churidar leggings, has an elasticated waistband'),
...
INSERT INTO `reviews` (`rid`, `pid`, `pname`, `username`, `email`, `review`, `ip`, `comments`, `ip_address`) VALUES
(1, '12', 'Levis Blue Shirt', 'shiva', 'shiva@gmail.com', 'good\r\nawesome\r\nvery nice\r\nsfdadsg\r\nsdagv\r\nsdg\r\nsdtret\r\nyreahgba\r\near\r\ngretyreyery\r\neryt\r\nreytert\r\nreyethfd\r\ngyreayreayreayreygfagreat\r\net\r\nerwtreay\r\nery\r\nreyre', '10.100.34.54', NULL, NULL),
(2, '12', 'Levis Blue Shirt', 'dodda', 'dodda@gmail.com', 'bad\r\nnot at all good\r\nvery costly', '10.100.34.56', NULL, NULL),
(4, '12  ', 'Levis Blue Shirt', 'Shiva Achar', 'shiva111@gmail.com ', 'good', '127.0.0.1', NULL, NULL),
(5, '12  ', 'Levis Blue Shirt', 'Shiva Achar', 'shiva111@gmail.com ', 'nice', '127.0.0.1', NULL, NULL),
(6, '12  ', 'Levis Blue Shirt', 'Shiva Achar', 'shiva111@gmail.com ', 'nice', '127.0.0.1', 'commment', NULL),
(7, '12  ', 'Levis Blue Shirt', 'Shiva Achar', 'shiva111@gmail.com ', 'good', '127.0.0.1', NULL, NULL),
(8, '12  ', 'Levis Blue Shirt', 'Shiva Achar', 'shiva111@gmail.com ', 'nice', '127.0.0.1', NULL, NULL),
(9, '11  ', 'Levis White Shirt', 'Shiva Achar', 'shiva111@gmail.com ', 'nice shirt', '127.0.0.1', NULL, NULL),
(10, '113  ', 'Levis Blue Jeans', 'Shiva Achar', 'shiva111@gmail.com ', 'good blue jeans', '127.0.0.1', NULL, NULL),
(45, '110 ', 'Adidas Red Shirt', 'root', ' ', 'good', '127.0.0.1', NULL, NULL),
(46, '11 ', 'Levis White Shirt', 'root', ' ', 'good', '127.0.0.1', NULL, NULL),
(47, '110 ', 'Adidas Red Shirt', 'root', ' ', 'nice', '127.0.0.1', NULL, NULL),
(48, '14 ', 'Adidas Brown Shirt', 'root', ' ', 'nice shirt', '127.0.0.1', NULL, NULL);
...
('joy mwangi', 'joy@gmail.com', '12345678', '0712345678', 'nakuru 271267'),
...
ALTER TABLE `reviews`
  ADD PRIMARY KEY (`rid`);
ALTER TABLE `reviews` ADD FULLTEXT KEY `ip` (`ip`);
